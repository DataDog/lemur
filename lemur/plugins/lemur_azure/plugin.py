...
class AzureDestinationPlugin(DestinationPlugin):
    ...
    def upload(self, name, body, private_key, cert_chain, options, **kwargs):
        ...
        certificate_client = CertificateClient(
            credential=get_azure_credential(audience="https://vault.azure.net/.default", plugin=self, options=options),
...
class AzureSourcePlugin(SourcePlugin):
    ...
    def get_certificates(self, options, **kwargs):
        certificates = []
        certificate_client = CertificateClient(
            credential=get_azure_credential(audience="https://management.azure.com/.default", plugin=self, options=options),
            vault_url=self.get_option("azureKeyVaultUrl", options),
        )
