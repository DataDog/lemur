...
setup(
    ...
    entry_points={
        ...
        'lemur.plugins': [
            ...
            'cert_orchestration_adapter_destination = cert_orchestration_adapter.plugin:AdapterDestinationPlugin',
            'cert_orchestration_adapter_source = cert_orchestration_adapter.plugin:AdapterSourcePlugin',
